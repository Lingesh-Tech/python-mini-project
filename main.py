...
lbl = tk.Label(window, text="OBJECT DETECTION USING PYTHON", font=("Arial Bold", 24), fg='red')
...
exitBtn = tk.Button(window, text=' Exit ', command=close_window)
exitBtn.grid(column=1, row=4, padx=15)
